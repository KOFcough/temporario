...
while True:
    print("")
    print(f"Bem vindo {login}! \n 1-Agendar \n 2-Ver meu agendamento mais recente \n 3-Sair")
    escolha = int(input(""))
    print("")
    # opções de menu
    if escolha == 1:
        ...
        # escolhendo lab
        print("")
        labEscolhido = str(input("Escolha o lab que deseja agendar: "))
        print("")
        ...
        diaEscolhido = int(input("Escolha o dia: "))
        print("")
    ...
    # mostrando agendamento mais recente
    elif escolha == 2:
        print(f"Seus agendamentos são: \n Laboratório: {labEscolhido} \n Dia: {diaEscolhido}")
    # sair do menu
    elif escolha == 3:
        break
